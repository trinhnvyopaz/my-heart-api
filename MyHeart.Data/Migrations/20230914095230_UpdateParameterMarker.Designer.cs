...
namespace MyHeart.Data.Migrations
{
    ...
    [Migration("20230914095230_UpdateParameterMarker")]
    partial class UpdateParameterMarker
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyHeart.Data.Models.Marker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyHeart.Data.Models.NonpharmaticTherapy_Synonyms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NonpharmaticTherapy_Synonyms");
                });
            ...
            modelBuilder.Entity("MyHeart.Data.Models.Parameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ResultExclusion")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyHeart.Data.Models.PatientMedicalExamination", b =>
                {
                    ...
                    b.Property<string>("AfterMarkerReally")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BeforeMarkerReally")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DateMined")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DateMinedArea")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DateMinedReal")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("DiseasePharmacyId")
                        .HasColumnType("int");

                    b.Property<string>("DoseMined")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DoseMinedRelly")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DoseMinedSource")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DoseUnitMined")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FrequencyMined")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsSelected")
                        .HasColumnType("bit");

                    b.Property<string>("ItemMined")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Key")
                        .HasColumnType("int");

                    b.Property<string>("KeywordRelly")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NoteMined")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PathSaving")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("PatientMedicalRecordId")
                        .HasColumnType("int");

                    b.Property<string>("ResultExclusionReally")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SearchAreaReal")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyHeart.Data.Models.PatientMedicalRecord", b =>
                {
                    ...
                    b.Property<int>("UserReportFileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyHeart.Data.Models.ProfessionInformation.Disease_Synonyms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyHeart.Data.Models.ProfessionInformation.PreventiveMeasures_Synonyms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PreventiveMeasures_Synonyms");
                });
            ...
            modelBuilder.Entity("MyHeart.Data.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyHeart.Data.Models.Symptom_Synonyms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyHeart.Data.Models.Marker", b =>
                {
                    b.HasOne("MyHeart.Data.Models.Parameter", "Parameter")
                        .WithMany("Markers")
            ...
            modelBuilder.Entity("MyHeart.Data.Models.PatientMedicalRecord", b =>
                {
                    b.HasOne("MyHeart.Data.Models.UserReportFile", "UserReportFile")
                        .WithMany()
                        .HasForeignKey("UserReportFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyHeart.Data.Models.Symptom_Synonyms", b =>
                {
                    b.HasOne("MyHeart.Data.Models.Symptoms", "Symptom")
                        .WithMany("Synonyms")
